export const About = ()=>{
    return<>
    <div className="block sm:flex p-6 text-white justify-center items-center w-full">
        {/* first section */}
        ...
        <div className=" block p-6 justify-center items-center">
            ...
            <div className="flex w-full justify-center items-center mt-10 sm:text-[20px] text-[20px] font-mono">
                <h3>Developer & </h3>
                <h3 className="text-blue-700 pl-2">  Designer &copy;</h3>
            </div>

            <div className="w-full justify-center items-center mt-4">
                <p className="w-full justify-center items-center text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum, inventore corporis quaerat voluptas dolorem esse nostrum quia minus eum repellendus illum, vitae repudiandae, quod facere numquam fugiat! Laboriosam, sunt nam.
                </p>
            </div>

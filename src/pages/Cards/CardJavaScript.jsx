    ...
    return<div className="flex flex-col font-serif">
            ...
            <div className={`flex flex-col justify-center items-center p-4 rounded-xl h-full`} style={{backgroundColor : changeJavaScript}}>
                <div className={`${openJavaScript? "hidden" : "block"}`}>
                    ...
                    <p className="text-center italic mt-3"> Javascript is a programming language used to make web pages interactive. it runs in web browser and controls dynamic content like animations, fomr validation, and real-time updates </p>
                </div>
